...
class IsLastQuarterTest extends BaseDateTest {

    protected const PREDICATE = 'is_last_quarter';
    ...
    public function false_args(): array
    {
        ...
        $same_quarter_as_last_quarter_different_year = sprintf("%s-%s-01T00:00+00:00", $this->getLastQuarterYear() + 2, $first_month_last_quarter);
        ...
        return [
            ...
            [$same_quarter_as_last_quarter_different_year],
        ];
    }
    ...
    {
        $first_month_last_quarter = $this->getLastQuarterInt() * 3 - 2;
        $date_as_str = sprintf("%s-%s-01T00:00+00:00", $this->getLastQuarterYear(), $first_month_last_quarter);
